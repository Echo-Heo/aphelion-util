...
pub mod ops {
    ...
    pub trait Float: Copy + num_traits::float::Float {
        ...
        fn write_u64(self, v: &mut u64) { *v = self.to_bits().into() }
        fn to_u64(self) -> u64 { self.to_bits().into() }
        ...
        #[must_use]
        fn fto(int: u64) -> u64 { Self::cast_from_int(int as i64).to_u64() }
        #[must_use]
        fn ffrom(float: u64) -> u64 { Self::from_u64(float).cast_to_int() as u64 }
        #[must_use]
        fn fneg(a: u64) -> u64 { Self::from_u64(a).neg().to_u64() }
        #[must_use]
        fn fabs(a: u64) -> u64 { Self::from_u64(a).abs().to_u64() }
        #[must_use]
        fn fadd(a: u64, b: u64) -> u64 { (Self::from_u64(a) + Self::from_u64(b)).to_u64() }
        #[must_use]
        fn fsub(a: u64, b: u64) -> u64 { (Self::from_u64(a) - Self::from_u64(b)).to_u64() }
        #[must_use]
        fn fmul(a: u64, b: u64) -> u64 { (Self::from_u64(a) * Self::from_u64(b)).to_u64() }
        #[must_use]
        fn fdiv(a: u64, b: u64) -> u64 { (Self::from_u64(a) / Self::from_u64(b)).to_u64() }
        fn fma(a: u64, b: u64, to: &mut u64) { (Self::from_u64(*to) + Self::from_u64(a) * Self::from_u64(b)).write_u64(to); }
        #[must_use]
        fn fsqrt(a: u64) -> u64 { Self::from_u64(a).sqrt().to_u64() }
        #[must_use]
        fn fmin(a: u64, b: u64) -> u64 { Self::from_u64(a).min(Self::from_u64(b)).to_u64() }
        #[must_use]
        fn fmax(a: u64, b: u64) -> u64 { Self::from_u64(a).max(Self::from_u64(b)).to_u64() }
        #[must_use]
        fn fsat(a: u64) -> u64 { Self::from_u64(a).ceil().to_u64() }
        #[must_use]
        fn fnan(a: u64) -> u64 { u64::from(Self::from_u64(a).is_nan()) }
    }
